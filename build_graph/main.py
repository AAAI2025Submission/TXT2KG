...
parser.add_argument('--load_path', type=str, default="disease")
...
def get_extraction_chain(
    ...
    prompt = ChatPromptTemplate.from_messages(
        [(
          "system",
          f"""# Medical Knowledge Graph Instructions for GPT-4
## 1. Overview
You are a top-tier algorithm designed for extracting medical information, converting them into structured formats to build a medical knowledge graph. Try your best to structure it into nodes and relationships (Please use node properties as few as possible).
