...
def set_prompt(input_type):
    if input_type=="Entity":
        ...
        ## 1. Overview
        You are a a top-tier algorithm designed for merging EXACTLY THE SAME entity in a medical knowledge graph. Your tasks are:
        ...
        ## 5. Examples:
        - Example 1:
        -- Input: ['Hypertension', 'High blood pressure', 'Myocardial infarction']
        -- Output: ['Hypertension', 'High blood pressure']
        
        - Example 2:
        -- Input: ['Heart attack', 'High blood pressure', 'Myocardial infarction']
        -- Output: ['Heart attack', 'Myocardial infarction']
        
        - Example 3:
        -- Input: ['Diabetes', 'Hyperglycemia', 'Myocardial infarction']
        -- Output: ['None']
        -- Explanation: There are no EXACTLY THE SAME entity names in the input list. Because hyperglycemia is a symptom of diabetes, not an exact synonym.
        
        - Example 4:
        -- Input: ['Infection', 'Inflammation']
        -- Output: ['None']
        ...
        prompt = ChatPromptTemplate.from_messages(
            [(
                ...
                ## 1. Overview
                You are a a top-tier algorithm designed for merging EXACTLY THE SAME relation in a medical knowledge graph. Your tasks are:
